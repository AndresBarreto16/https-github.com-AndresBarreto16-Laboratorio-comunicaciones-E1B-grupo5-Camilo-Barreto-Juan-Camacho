...
# Title: ModulacionFM
# Author: CamiloBarreto_JuanCamacho
...
class ModulacionFM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._kp_range = qtgui.Range(0, 10, 100e-3, 1, 200)
        ...
        self._Am_range = qtgui.Range(0, 20, 100e-3, 1, 200)
        ...
        self._Ac_range = qtgui.Range(0, 20, 100e-3, 250e-3, 200)
