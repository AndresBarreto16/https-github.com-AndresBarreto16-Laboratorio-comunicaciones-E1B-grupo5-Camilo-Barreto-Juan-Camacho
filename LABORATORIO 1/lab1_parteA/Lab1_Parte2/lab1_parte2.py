...
# Title: lab1_parte2_muestreo
# Author: Camilo_Barreto_Juan_Camacho
...
class lab1_parte2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab1_parte2_muestreo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab1_parte2_muestreo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1_parte2")
...
def main(top_block_cls=lab1_parte2, options=None):
