...
# Title: modulacion de emisoras
# Copyright: Camilo_Barreto_Juan_Camacho
...
class modulacionFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "modulacion de emisoras ", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("modulacion de emisoras ")
